...
<body id="top">
    ...
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5 col-12 mb-5">
                        ...
                        <h2 class="text-white">Data Agama<br> WNI </h2>
        ...
        <a href="{{ route('agamas.create') }}" class="btn btn-primary">Tambah Agama</a>
        ...
        <tbody>
            @foreach($agamas as $agama)
                <tr>
                    ...
                    <td>{{ $agama->agama }}</td>
                    <td>
                        <a href="{{ route('agamas.show', $agama->id) }}" class="btn btn-info">Lihat</a>
                        <a href="{{ route('agamas.edit', $agama->id) }}" class="btn btn-warning">Edit</a>
                        <form action="{{ route('agamas.destroy', $agama->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
