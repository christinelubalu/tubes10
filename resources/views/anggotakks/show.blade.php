...
<body id="top">
    ...
    <main>
        ...
        <p>ID: {{ $anggotakks->id }}</p>
    <p>KK ID: {{ $anggotakks->kk->id }}</p>
    <p>Penduduk ID: {{ $anggotakks->penduduk->id }}</p>
    <p>Hubungan KK ID: {{ $anggotakks->hubungankk->id }}</p>
    <p>Status Aktif: {{ $anggotakks->statusaktif }}</p>
