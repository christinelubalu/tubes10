...
<body id="top">
    ...
    <main>
                    ...
                    <div class="col-lg-5 col-12 mb-5">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Hubungankk</li>
                            </ol>
                        </nav>

                        <h2 class="text-white">Edit<br>Hubungan KK</h2>
        ...
        <form method="post" action="{{ route('hubungankks.update', $hubungankks->id) }}">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="hubungankk">Hubungan KK:</label>
            <input type="text" class="form-control" id="hubungankk" name="hubungankk" value="{{ $hubungankks->hubungankk }}" required>
        </div>
