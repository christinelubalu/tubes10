...
<body id="top">
    ...
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5 col-12 mb-5">
                        ...
                        <h2 class="text-white">Edit<br>Kartu Keluarga</h2>
        ...
        <form method="post" action="{{ route('kks.update', $kks->id) }}">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="nokk">Nomor KK:</label>
            <input type="text" class="form-control" id="nokk" name="nokk" value="{{ $kks->nokk }}" required>
        </div>
        <div class="form-group">
    <label for="statusaktif">Status Aktif:</label>
    <select class="form-control" id="statusaktif" name="statusaktif" required>
        <option value="aktif" {{ $kks->statusaktif == 'aktif' ? 'selected' : '' }}>Aktif</option>
        <option value="tidak aktif" {{ $kks->statusaktif == 'tidak aktif' ? 'selected' : '' }}>Tidak Aktif</option>
    </select>
</div>
