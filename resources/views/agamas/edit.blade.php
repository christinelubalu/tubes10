...
<body id="top">
    ...
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5 col-12 mb-5">
                        ...
                        <h2 class="text-white">Edit Agama<br> WNI </h2>
        ...
        <form method="post" action="{{ route('agamas.update', $agama->id) }}">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="agama">Nama Agama:</label>
            <input type="text" class="form-control" id="agama" name="agama" value="{{ $agama->agama }}" required>
        </div>
